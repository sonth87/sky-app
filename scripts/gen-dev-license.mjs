 ...
 * xem apps/shell-electron/src/license-config.ts's DEV_LICENSE_PUBLIC_KEY_HEX
 * để biết public key tương ứng đang nhúng trong app).
 *
...
// Khớp DEV_LICENSE_PUBLIC_KEY_HEX trong apps/shell-electron/src/license-config.ts —
