...
**Khi task là TẠO hoặc SỬA một app con** → đọc [`docs/guides/app-spec.md`](./docs/guides/app-spec.md) (quy chuẩn app con: là gì, phải/không được làm gì, vòng đời, capability, giao tiếp, CSS/theme, verify, anti-patterns).
